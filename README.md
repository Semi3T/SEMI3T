            ...
            <td rowspan="2" width="600px">
              ...
              <li><strong>개인작업</strong>
                <ol start="1">
                  ...
                  <li>페이징 기능, 탑-다운 스크롤 기능, 전체적인 css 작업 및 기능 체크</li>
                </ol>
              </li>
          ...
          <tr>
            ...
            <td rowspan="2">
              ...
              <li><strong>개인작업</strong>
                <ol start="1">
                  <li>QnA 게시판 구현</li>
                  <li>푸터 작성, QnA게시판 및 댓글기능의 master 자유 접근 구현</li>
                </ol>
              </li>
              <li><strong>소감</strong></li>
                <li>많은 시행착오가 있었고, 진행이 체계적이며 순탄했다 라고 볼 순 없지만, 해당 프로젝트를 진행하며 다음 프로젝트에 취해야할 자세와 순서와 같은 협업에 중점을 둔 학습을 많이 할 수 있었다고 생각합니다. 진행기간동안 다사다난 했지만, 마찰없이 의기투합 해준 팀원들에게 감사의 말을 남깁니다.</li>
            </td>
          </tr>
          <tr>
